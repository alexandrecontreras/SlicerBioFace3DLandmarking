...
Includes a **mesh standardization** step to align meshes to the reference space expected by the BioFace3D landmarking models (**required for most meshes**).
...
This extension integrates the landmarking functionality directly into 3D Slicer and adds a standardization step to align your mesh to the reference space used by the models.
...
<!-- Screenshot placeholders (replace/add files later) -->
![TODO: Standardization single tab UI](Screenshots/TODO_standardization_single_ui.png)

![TODO: Standardization result](Screenshots/TODO_standardization_result.png)
...
- Downloaded weights are stored in a local cache and reused on later runs.
...
![TODO: Landmarking single UI](Screenshots/TODO_landmarking_single_ui.png)
### Batch (directory mode)
...
![TODO: Landmarking batch UI](Screenshots/TODO_landmarking_batch_ui.png)
